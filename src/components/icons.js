...
function Logo({ variant }) {
  let logoData = {
    ...
    tailwind: { text: "Tailwind CSS", logo: "tailwind-css", logoColor: "06B6D4" },
    ...
    express: { text: "Express.js", logo: "express", logoColor: "000000" },
  ...
  return <img className="mr-5" height={25} src={url} />;
